  ...
  imports: [
    ...
    ConfigModule.forRoot({
      ...
      validationSchema: Joi.object({
        ...
        EASEE_BASE_URL: Joi.string().allow('').default('https://api.easee.com'),
        ...
        EASEE_ACCOUNT_ID: Joi.alternatives().try(Joi.number(), Joi.string().allow('')).default(''),
        EASEE_SITES_PATH: Joi.string().allow('').default(''),
        EASEE_SITE_CHARGERS_PATH_TEMPLATE: Joi.string().allow('').default(''),
        EASEE_SITE_DETAIL_PATH_TEMPLATE: Joi.string().allow('').default(''),
        EASEE_DEFAULT_LOCATION_ADDRESS: Joi.string().allow('').default(''),
        EASEE_DEFAULT_LOCATION_LATITUDE: Joi.alternatives().try(Joi.number(), Joi.string().allow('')).default(''),
        EASEE_DEFAULT_LOCATION_LONGITUDE: Joi.alternatives().try(Joi.number(), Joi.string().allow('')).default(''),
      }),
    }),
